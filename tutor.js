...
var _vmchale$typing_tutor$State$showDifficulty = function (diff) {
	...
	switch (_p0.ctor) {
		...
		case 'Sentences':
			return 'Sentences';
		case 'Punctuation':
			return 'Punctuation & Typographical Marks';
		default:
...
var _vmchale$typing_tutor$State$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
...
var _vmchale$typing_tutor$State$Numerals = {ctor: 'Numerals'};
var _vmchale$typing_tutor$State$Punctuation = {ctor: 'Punctuation'};
var _vmchale$typing_tutor$State$Sentences = {ctor: 'Sentences'};
var _vmchale$typing_tutor$State$Phrases = {ctor: 'Phrases'};
var _vmchale$typing_tutor$State$Words = {ctor: 'Words'};
var _vmchale$typing_tutor$State$Subjoined = {ctor: 'Subjoined'};
var _vmchale$typing_tutor$State$Vowels = {ctor: 'Vowels'};
var _vmchale$typing_tutor$State$succ = function (d) {
	var _p2 = d;
	switch (_p2.ctor) {
		case 'Consonants':
			return _vmchale$typing_tutor$State$Vowels;
		case 'Vowels':
			return _vmchale$typing_tutor$State$Subjoined;
		case 'Subjoined':
			return _vmchale$typing_tutor$State$Words;
		case 'Words':
			return _vmchale$typing_tutor$State$Phrases;
		case 'Phrases':
			return _vmchale$typing_tutor$State$Sentences;
		default:
			return _vmchale$typing_tutor$State$Sentences;
	}
};
var _vmchale$typing_tutor$State$Consonants = {ctor: 'Consonants'};
var _vmchale$typing_tutor$State$fromString = function (str) {
	var _p3 = str;
	switch (_p3) {
		case 'Consonants':
			return _vmchale$typing_tutor$State$Consonants;
		case 'Vowels':
			return _vmchale$typing_tutor$State$Vowels;
		default:
			return _vmchale$typing_tutor$State$Consonants;
...
var _vmchale$typing_tutor$State$init = function (savedState) {
	...
	if (_p4.ctor === 'Just') {
		return {
			ctor: '_Tuple2',
			_0: _vmchale$typing_tutor$State$Model('')('')(
				_elm_lang$core$Native_Utils.chr('ང'))(false)(false)(_elm_lang$core$Maybe$Nothing)(_vmchale$typing_tutor$State$Consonants)(
		...
		return {
			ctor: '_Tuple2',
			_0: _vmchale$typing_tutor$State$Model('')('')(
				_elm_lang$core$Native_Utils.chr('ང'))(false)(false)(_elm_lang$core$Maybe$Nothing)(_vmchale$typing_tutor$State$Consonants)(_vmchale$typing_tutor$State$Consonants)(
				{ctor: '[]'})(false),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	}
};
var _vmchale$typing_tutor$State$SetDifficulty = function (a) {
	return {ctor: 'SetDifficulty', _0: a};
};
var _vmchale$typing_tutor$State$RandomString = function (a) {
	return {ctor: 'RandomString', _0: a};
};
var _vmchale$typing_tutor$State$KeyMsg = function (a) {
	return {ctor: 'KeyMsg', _0: a};
};
var _vmchale$typing_tutor$State$None = {ctor: 'None'};

var _vmchale$typing_tutor$Update_Lang$helper = function (c) {
	var _p0 = c;
	switch (_p0.valueOf()) {
		case '[':
			return 219;
...
var _vmchale$typing_tutor$Update_Lang$c = function (s) {
...
var _vmchale$typing_tutor$Update_Lang$subjoinedCharsLatin = A2(
	_elm_lang$core$List$map,
	_vmchale$typing_tutor$Update_Lang$c,
	A2(_elm_lang$core$String$split, '', '9C9Y9L9R'));
var _vmchale$typing_tutor$Update_Lang$subjoinedChars = A2(
	_elm_lang$core$List$map,
	_vmchale$typing_tutor$Update_Lang$c,
	A2(_elm_lang$core$String$split, '', 'སྐཀྱཀླཀྲ'));
var _vmchale$typing_tutor$Update_Lang$keymapSubjoined = _elm_lang$core$Dict$fromList(
	A2(
		_elm_lang$core$List$map,
		function (_p2) {
			var _p3 = _p2;
			return {
				ctor: '_Tuple2',
				_0: _vmchale$typing_tutor$Update_Lang$helper(_p3._0),
				_1: _p3._1
			};
		},
		A3(
			...
			_vmchale$typing_tutor$Update_Lang$subjoinedCharsLatin,
			_vmchale$typing_tutor$Update_Lang$subjoinedChars)));
var _vmchale$typing_tutor$Update_Lang$tibChars = A2(
	_elm_lang$core$List$map,
	_vmchale$typing_tutor$Update_Lang$c,
	A2(_elm_lang$core$String$split, '', 'ཨཧཝཅཆེརཏཡིོུཕཙཚཛའསདབངམ་གལཞ།ཟཤཀཁཔནཐཇཉ'));
var _vmchale$typing_tutor$Update_Lang$latinChars = A2(
	_elm_lang$core$List$map,
	_vmchale$typing_tutor$Update_Lang$c,
	A2(_elm_lang$core$String$split, '', '`-=QWERTYUIOP[]\\ASDFGHJKL;\'ZXCVBN,./'));
var _vmchale$typing_tutor$Update_Lang$keymap = _elm_lang$core$Dict$fromList(
	A2(
		_elm_lang$core$List$map,
		function (_p4) {
			var _p5 = _p4;
			return {
				ctor: '_Tuple2',
				_0: _vmchale$typing_tutor$Update_Lang$helper(_p5._0),
				_1: _p5._1
			};
		},
		A3(
			...
			_vmchale$typing_tutor$Update_Lang$latinChars,
			_vmchale$typing_tutor$Update_Lang$tibChars)));
...
var _vmchale$typing_tutor$Update_Lang$punctuation = _elm_lang$core$Array$fromList(
	{
		ctor: '::',
		_0: '་',
		_1: {
...
var _vmchale$typing_tutor$Update_Lang$vowels = _elm_lang$core$Array$fromList(
	{
		ctor: '::',
		_0: 'ཨ',
		_1: {
...
var _vmchale$typing_tutor$Update_Lang$words = _elm_lang$core$Array$fromList(
	{
		ctor: '::',
		_0: 'བོད་',
		_1: {
...
var _vmchale$typing_tutor$Update_Lang$ratak = _elm_lang$core$Array$fromList(
	{
		ctor: '::',
		_0: 'ཀྲ',
		_1: {
...
var _vmchale$typing_tutor$Update_Lang$latak = _elm_lang$core$Array$fromList(
	{
		ctor: '::',
		_0: 'ཀླ',
		_1: {
...
var _vmchale$typing_tutor$Update_Lang$yatak = _elm_lang$core$Array$fromList(
	{
		ctor: '::',
		_0: 'ཀྱ',
		_1: {
...
var _vmchale$typing_tutor$Update_Lang$subjoined = A2(
	_elm_lang$core$Array$append,
	_vmchale$typing_tutor$Update_Lang$yatak,
	A2(_elm_lang$core$Array$append, _vmchale$typing_tutor$Update_Lang$latak, _vmchale$typing_tutor$Update_Lang$ratak));
var _vmchale$typing_tutor$Update_Lang$consonants = _elm_lang$core$Array$fromList(
	A2(_elm_lang$core$String$split, '', 'ཨཧཝཅཆརཏཡཕཙཚཛའསདབངམགལཞཟཤཀཁཔནཐཇཉ'));

var _vmchale$typing_tutor$Update$getArray = function (d) {
	var _p0 = d;
	switch (_p0.ctor) {
		case 'Consonants':
			return _vmchale$typing_tutor$Update_Lang$consonants;
		case 'Vowels':
			return _vmchale$typing_tutor$Update_Lang$vowels;
		case 'Subjoined':
			return _vmchale$typing_tutor$Update_Lang$subjoined;
		case 'Words':
			return _vmchale$typing_tutor$Update_Lang$words;
		case 'Phrases':
			return _vmchale$typing_tutor$Update_Lang$phrases;
		case 'Sentences':
			return _vmchale$typing_tutor$Update_Lang$sentences;
		case 'Numerals':
			return _vmchale$typing_tutor$Update_Lang$numerals;
		default:
			return _vmchale$typing_tutor$Update_Lang$punctuation;
	}
};
var _vmchale$typing_tutor$Update$levelNum = function (d) {
	var _p1 = d;
	switch (_p1.ctor) {
		case 'Consonants':
			return 20;
...
var _vmchale$typing_tutor$Update$enoughProgress = F2(
	function (l, d) {
		return _elm_lang$core$Native_Utils.cmp(
			A3(
				_elm_lang$core$List$foldr,
				...
				0,
				l),
			((17 * _vmchale$typing_tutor$Update$levelNum(d)) / 20) | 0) > -1;
	});
var _vmchale$typing_tutor$Update$getChar = function (s) {
	var _p2 = _elm_lang$core$String$uncons(s);
	if (_p2.ctor === 'Just') {
		return _p2._0._0;
	} else {
		return _elm_lang$core$Native_Utils.chr('བ');
	}
};
var _vmchale$typing_tutor$Update$fromMaybe = F2(
	function (def, val) {
		var _p3 = val;
		if (_p3.ctor === 'Just') {
			return _p3._0;
...
var _vmchale$typing_tutor$Update$getNext = function (ls) {
	return A2(
		_elm_lang$core$Random$generate,
		function (i) {
			return function (_p4) {
				return _vmchale$typing_tutor$State$RandomString(
					A2(
						_vmchale$typing_tutor$Update$fromMaybe,
						'Error',
						A2(_elm_lang$core$Array$get, i, _p4)));
			}(ls);
		},
		A2(
			_elm_lang$core$Random$int,
			0,
			_elm_lang$core$Array$length(ls) - 1));
};
	...
	function (subjoined, i) {
		...
		if (_p5 === false) {
			return A2(
				...
				A2(_elm_lang$core$Dict$get, i, _vmchale$typing_tutor$Update_Lang$keymap));
		} else {
			return A2(
				_elm_lang$core$Maybe$withDefault,
				_elm_lang$core$Char$fromCode(i),
				A2(_elm_lang$core$Dict$get, i, _vmchale$typing_tutor$Update_Lang$keymapSubjoined));
		}
	});
var _vmchale$typing_tutor$Update$addCompletedSubjoined = function (i) {
	var _p6 = A2(_elm_lang$core$Dict$get, i, _vmchale$typing_tutor$Update_Lang$keymapSubjoined);
	if (_p6.ctor === 'Just') {
		return _elm_lang$core$String$fromChar(_p6._0);
	} else {
		return '';
	}
};
var _vmchale$typing_tutor$Update$addCompleted = function (i) {
	var _p7 = A2(_elm_lang$core$Dict$get, i, _vmchale$typing_tutor$Update_Lang$keymap);
	if (_p7.ctor === 'Just') {
		return _elm_lang$core$String$fromChar(_p7._0);
	} else {
		return '';
	}
};
			...
			case 'RandomString':
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						st,
						{
							nextGoal: A2(_elm_lang$core$String$dropLeft, 1, _p9),
							nextChar: _vmchale$typing_tutor$Update$getChar(_p9),
							failed: false
						}),
					{ctor: '[]'});
			default:
				if (_p8._0 === 113) {
					...
					var fail = !_elm_lang$core$Native_Utils.eq(
						A2(_vmchale$typing_tutor$Update$mkKeyPress, st.composeNext, _p11),
						st.nextChar);
					...
					var newDifficultyLevel = A2(_vmchale$typing_tutor$Update$enoughProgress, pastProgress, st.difficultyLevel) ? _vmchale$typing_tutor$State$succ(st.difficultyLevel) : st.difficultyLevel;
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
							st,
							{
								...
								completed: (!done) ? A2(
									_elm_lang$core$Basics_ops['++'],
									st.completed,
									(!fail) ? ((!st.composeNext) ? _vmchale$typing_tutor$Update$addCompleted(_p11) : _vmchale$typing_tutor$Update$addCompletedSubjoined(_p11)) : '') : '',
								...
								maxDifficulty: (_elm_lang$core$Native_Utils.cmp(
									...
									_vmchale$typing_tutor$State$toInt(st.difficultyLevel)) < 1) ? st.maxDifficulty : newDifficultyLevel,
						...
						(!done) ? {ctor: '[]'} : {
							ctor: '::',
							_0: function (_p10) {
								return _vmchale$typing_tutor$Update$getNext(
									_vmchale$typing_tutor$Update$getArray(_p10));
							}(st.difficultyLevel),
							_1: {ctor: '[]'}
						});
				}
...
var _vmchale$typing_tutor$View$allDifficulties = {
	ctor: '::',
	_0: _vmchale$typing_tutor$State$Consonants,
	_1: {
		ctor: '::',
		_0: _vmchale$typing_tutor$State$Vowels,
		_1: {
			ctor: '::',
			_0: _vmchale$typing_tutor$State$Words,
			_1: {
				ctor: '::',
				_0: _vmchale$typing_tutor$State$Phrases,
				_1: {
					ctor: '::',
					_0: _vmchale$typing_tutor$State$Sentences,
					_1: {
						ctor: '::',
						_0: _vmchale$typing_tutor$State$Punctuation,
						_1: {
							ctor: '::',
							_0: _vmchale$typing_tutor$State$Numerals,
							_1: {ctor: '[]'}
						}
					}
				}
...
var _vmchale$typing_tutor$View$largeText = function (b) {
	return b ? _elm_lang$html$Html_Attributes$style(
		{
			ctor: '::',
...
var _vmchale$typing_tutor$View$helper = F2(
	function (diff, b) {
		var _p0 = diff;
		switch (_p0.ctor) {
			case 'Consonants':
				return A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _vmchale$typing_tutor$View$largeText(b),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Use the picture below to type consonants.'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					});
				...
				return A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Vowel markers always appear modifying a consonant. Type the vowel after the consonant.'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					});
				...
				return A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Words separate units by the \'་\' character (called a ཚེག). These units consist of a root letter, and possibly a vowel marker, prefix letter, suffix, or second suffix'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					});
				...
				return A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('To subjoin a letter, type the top consonant, followed by the compose key (\'m\') and then the bottom letter. Type any vowels after that.'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					});
				...
				return A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Separate units of text know as དོན་ཚན་with a ། (called a ཤད་)'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					});
				...
				return A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('The ཡིང་མགོ་ (༄༅) is used in དཔེ་ཆ་, but it is not used in books.'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					});
...
var _vmchale$typing_tutor$View$displayMessage = F2(
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Available Lessons: '),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						A2(
							...
							A3(
										...
										return A2(
											_elm_lang$html$Html$span,
											{
												...
												_0: _elm_lang$html$Html_Events$onClick(
													_vmchale$typing_tutor$State$SetDifficulty(diff)),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
								...
								_vmchale$typing_tutor$View$allDifficulties,
								A2(
									_elm_lang$core$List$map,
									...
									A2(
										...
										function (d) {
											return _elm_lang$core$Native_Utils.cmp(
												_vmchale$typing_tutor$State$toInt(d),
												_vmchale$typing_tutor$State$toInt(difficulty)) < 1;
										},
										_vmchale$typing_tutor$View$allDifficulties))))),
					_1: {ctor: '[]'}
				}
...
var _vmchale$typing_tutor$View$tibetanText = function (b) {
	return (!b) ? _elm_lang$html$Html_Attributes$style(
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'font-size', _1: '140%'},
			_1: {ctor: '[]'}
		}) : _elm_lang$html$Html_Attributes$style(
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'font-size', _1: '280%'},
			_1: {ctor: '[]'}
		});
};
var _vmchale$typing_tutor$View$pageStyles = {
	ctor: '::',
	_0: _seanhess$elm_style$Style$marginTop('80px'),
	_1: {
		ctor: '::',
		_0: _seanhess$elm_style$Style$marginLeft('80px'),
		_1: {
			ctor: '::',
			_0: _seanhess$elm_style$Style$marginRight('160px'),
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'font', _1: 'Tahoma, Geneva, sans-serif'},
				_1: {ctor: '[]'}
			}
		}
	}
};
var _vmchale$typing_tutor$View$progressBar = function (model) {
	var boolInt = function (b) {
		return b ? 1 : 0;
	};
	var past = A2(
		_elm_lang$core$List$take,
		_vmchale$typing_tutor$Update$levelNum(model.difficultyLevel),
		model.pastSuccesses);
	var count = _elm_lang$core$List$sum(
		A2(_elm_lang$core$List$map, boolInt, past));
	return {
		ctor: '_Tuple2',
		...
		_1: _elm_lang$core$String$concat(
			A2(
				...
				(((_vmchale$typing_tutor$Update$levelNum(model.difficultyLevel) * 17) / 20) | 0) - count,
				'-'))
	};
};
var _vmchale$typing_tutor$View$colorAttribute = function (color) {
	return _elm_lang$html$Html_Attributes$style(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'color',
				_1: _eskimoblood$elm_color_extra$Color_Convert$colorToHex(color)
			},
			_1: {ctor: '[]'}
		});
};
var _vmchale$typing_tutor$View$colorFailed = function (b) {
	return b ? _vmchale$typing_tutor$View$colorAttribute(_elm_lang$core$Color$red) : _vmchale$typing_tutor$View$colorAttribute(_elm_lang$core$Color$black);
};
var _vmchale$typing_tutor$View$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$style(_vmchale$typing_tutor$View$pageStyles),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _vmchale$typing_tutor$View$largeText(model.largeText),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Press <F2> to toggle large text'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
				...
				_0: A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Type the following: '),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
				_1: {
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _vmchale$typing_tutor$View$colorAttribute(_elm_lang$core$Color$green),
									_1: {
										ctor: '::',
										_0: _vmchale$typing_tutor$View$tibetanText(model.largeText),
										_1: {ctor: '[]'}
									}
								},
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(model.completed),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _vmchale$typing_tutor$View$colorFailed(model.failed),
										_1: {
											ctor: '::',
											_0: _vmchale$typing_tutor$View$tibetanText(model.largeText),
											_1: {ctor: '[]'}
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(model.nextGoal),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
					...
					_1: {
						...
						_1: {
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Progress towards next lesson: '),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
												...
												_0: A2(
													...
													},
													{
														...
														_0: function (_p2) {
															...
															_vmchale$typing_tutor$View$progressBar(model)),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}),
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _vmchale$typing_tutor$View$colorAttribute(_elm_lang$core$Color$grey),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
							...
							_1: {
								ctor: '::',
								_0: A2(_vmchale$typing_tutor$View$displayMessage, model.largeText, model.maxDifficulty),
								_1: {
									ctor: '::',
									_0: A2(_vmchale$typing_tutor$View$helper, model.difficultyLevel, model.largeText),
									_1: {
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$p,
...
var _vmchale$typing_tutor$Subscriptions$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _elm_lang$keyboard$Keyboard$downs(_vmchale$typing_tutor$State$KeyMsg),
			_1: {ctor: '[]'}
		});
};
			...
			_1: _elm_lang$core$Platform_Cmd$batch(
				{
					...
					_0: _vmchale$typing_tutor$Main$setStorage(
						_vmchale$typing_tutor$State$showDifficulty(newModel.difficultyLevel)),
					_1: {
						ctor: '::',
						_0: cmds,
						_1: {ctor: '[]'}
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _vmchale$typing_tutor$Main$main !== 'undefined') {
    _vmchale$typing_tutor$Main$main(Elm['Main'], 'Main', undefined);
}
